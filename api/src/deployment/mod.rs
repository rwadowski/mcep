...
#[get("/deployment/<id>")]
pub async fn get_deployment_handler(pool: &State<Pool<Postgres>>, id: i32) -> Result<String, NotFound<String>> {
...
pub async fn delete_deployment_handler(sender: &State<Sender<Command>>, pool: &State<Pool<Postgres>>, id: i32) -> Result<String, Status> {
